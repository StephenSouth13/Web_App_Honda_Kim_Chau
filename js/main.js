...
function initMobileMenu() {
  ...
  if (hamburger) {
    ...
    spans.forEach((span) => {
      ...
      span.style.backgroundColor = "var(--gray-700)";
...
// Initialize scroll header and mobile menu on all pages
...
function showAddPartModal() {
  showModal("Thêm phụ tùng m��i", getPartForm());
}
